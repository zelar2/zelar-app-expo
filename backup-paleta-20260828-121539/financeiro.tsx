...
const styles = StyleSheet.create({
  ...
  tab: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 12, backgroundColor: "#F1F5F9" },
  ...
  summaryBox: { flexDirection: "row", justifyContent: "space-between", backgroundColor: "#F1F5F9", borderRadius: 12, padding: 12, marginTop: 14 },
